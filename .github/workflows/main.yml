...
jobs:
  build:
    ...
    - name: Download ngrok
      run: |
        Invoke-WebRequest https://raw.githubusercontent.com/yatbot12/ngrok-rdp/main/resources/ngrok.zip -OutFile ngrok.zip
    ...
    - name: TimeCount
      run: |
        Invoke-WebRequest https://raw.githubusercontent.com/yatbot12/ngrok-rdp/main/resources/loop.ps1 -OutFile loop.ps1
        ./loop.ps1
